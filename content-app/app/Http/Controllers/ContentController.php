...
class ContentController extends Controller
{
    ...
    public function create(News $posts)
    {
        // $posts = News::all();
        $this->authorize('addPost', $posts);
        $categories = DB::table('categories')->select('*')->get();
        return view('news.post-add', compact('categories', 'posts'))->with('addPost', $posts);
    ...
    public function edit(News $posts)
    {
        ...
        $categories = DB::table('categories')->select('*')->get();
        return view('news.post-edit', compact('posts', 'categories'))->with('update', $posts);
    }
